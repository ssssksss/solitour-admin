...
const NotFound = () => {
  return (
    <main className="flex flex-col items-center justify-center gap-6 px-6 py-20">
      ...
      <div className="flex flex-row items-center gap-3 text-black dark:text-slate-200 max-[744px]:flex-col max-[744px]:gap-0">
        <h1 className="text-[2.25rem] font-bold">앗..요청하신 페이지를</h1>
        <h1 className="text-[2.25rem] font-bold">찾을 수 없습니다.</h1>
      </div>
      <div className="text-gray1 flex flex-col items-center dark:text-slate-400">
      ...
      <div className="flex flex-row items-center gap-[0.625rem]">
        <Link
          className="border-gray3 flex h-[2.625rem] w-[6.625rem] flex-row items-center justify-center rounded-full border-[0.0625rem] hover:scale-105 dark:border-slate-400 dark:bg-slate-600 dark:text-slate-400"
          href="/"
        >
          홈으로
        </Link>
